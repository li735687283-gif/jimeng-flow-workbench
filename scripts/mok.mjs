...
export function buildNode(type, options = {}) {
  ...
  if (type === 'image') Object.assign(data, { prompt: options.prompt || '', model: options.model || 'codex:gpt-5.5', width: numberValue(options.width, 'width', 1024), height: numberValue(options.height, 'height', 1024), count: numberValue(options.count, 'count', 1), inputImageAssetIds: [] });
